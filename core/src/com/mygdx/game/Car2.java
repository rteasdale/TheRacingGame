...
public Car2(){
                     this.carName = "Default Car";                      //Name of Car2
...
public Car2(String carName,double weight, double velocity, double acceleration, double maxVelocity, double maxReverseVelocity,
